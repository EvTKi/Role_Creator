...
class LoggerManager:
    ...
    def create_logger(
        ...
        """
        # Если логгер уже существует в нашем реестре, возвращаем его
        ...
        # ❗❗❗ ОЧИЩАЕМ ВСЕ ОБРАБОТЧИКИ — даже если логгер новый
        logger.handlers.clear()

        # ❗❗❗ ОТКЛЮЧАЕМ РАСПРОСТРАНЕНИЕ СООБЩЕНИЙ ВВЕРХ ПО ИЕРАРХИИ
